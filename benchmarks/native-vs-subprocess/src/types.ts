...
export const REQUIRED_CONTRACT_CHECKS = {
	...
	cli: [
		"ice_help",
		"ice_exposes_sub_yolo",
		"ice_exposes_ice_mode",
		"ice_exposes_ice_allow_bash",
		"stock_ice_help",
		"stock_ice_hides_sub_yolo",
		"stock_ice_hides_ice_mode",
		"stock_ice_hides_ice_allow_bash",
		"ice_rejects_backend_selection",
	],
} as const;
