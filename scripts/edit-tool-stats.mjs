...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".ice/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".ice/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.ice/agent/sessions)
