...
const internalPackagePrefix = "@zykairotis/ice-";
const installPackageName = "@zykairotis/ice-coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the Ice installer and updater.",
		dependencies: {
