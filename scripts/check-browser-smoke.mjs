...
const outputPath = join(tmpdir(), "ice-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "ice-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "ice-browser-smoke-errors.log");
