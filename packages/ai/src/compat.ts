/**
 * Temporary compatibility entrypoint preserving the old global ice-ai API
 ...
 *
 * Existing apps switch imports from "@zykairotis/ice-ai" to
 * "@zykairotis/ice-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/ice-messages.lazy.ts";
...
import { iceMessagesApi } from "./api/ice-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@zykairotis/ice-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@zykairotis/ice-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@zykairotis/ice-ai/providers/all" or `Models.getProviders()`. */
