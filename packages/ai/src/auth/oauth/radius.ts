 ...
 *
 * Radius is a ice-messages gateway. OAuth client APIs live on the configured
...
// This is the externally registered OAuth client, not the product's display name.
