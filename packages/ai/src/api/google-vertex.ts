...
import type {
	...
	AssistantMessage,
	Context,
	ThinkingLevel as IceThinkingLevel,
	Model,
	ProviderEnv,
	ProviderHeaders,
	SimpleStreamOptions,
...
type ClampedThinkingLevel = Exclude<IceThinkingLevel, "xhigh" | "max" | "ultra">;
...
function getDisabledThinkingConfig(model: Model<"google-vertex">): ThinkingConfig {
	...
	// thinkingLevel without includeThoughts so hidden thinking remains invisible to ice.
	const geminiModel = model as unknown as Model<"google-generative-ai">;
