...
/**
 * Converts models.dev verified effort values into Ice's selectable thinking levels.
 * Values without a Ice equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
