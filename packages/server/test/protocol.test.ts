import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@zykairotis/ice-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@zykairotis/ice-protocol";
...
describe("ice-ai protocol bridge", () => {
