...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|ice]   Update ice, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --fast                         Enable priority service tier for capable models
  --no-fast                      Disable priority service tier for this run
  ...
  --offline                      Disable startup network operations (same as ICE_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  ICE_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  ICE_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  ICE_TELEMETRY                     - Override install telemetry when set to 1/true/yes or 0/false/no
  ICE_SHARE_VIEWER_URL              - Base URL for /share command (default: https://pi.dev/session/)
