import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@zykairotis/ice-tui";
...
const OFFICIAL_PACKAGE_NAME = "@zykairotis/ice-coding-agent";
const OFFICIAL_APP_NAME = "ice";
const OFFICIAL_CONFIG_DIR_NAME = ".ice";
 ...
 * - this is the official Ice distribution (not a fork/rebrand)
 * - experimental features are enabled (ICE_EXPERIMENTAL=1)
