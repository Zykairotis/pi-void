    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="ice-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="ice-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'ice-share:v1:sidebar-width';
