...
import type { Api, ImageContent, Model, TextContent } from "@zykairotis/ice-ai";
...
function getIceDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getIceDocsClassification(absolutePath);
