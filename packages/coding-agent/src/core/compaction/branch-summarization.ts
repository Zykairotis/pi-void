...
import type { AgentMessage, StreamFn } from "@zykairotis/ice-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@zykairotis/ice-ai";
import { contentText } from "@zykairotis/ice-ai";
import type { Model, SimpleStreamOptions, Usage } from "@zykairotis/ice-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from ice-generated summaries (fromHook !== true), not extension-generated ones
