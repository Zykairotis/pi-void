...
export class RemoteSession {
	...
	private constructor(client: IceClient, options: RemoteSessionOptions = {}) {
		this.#client = client;
	...
	static async open(client: IceClient, sessionId: string, options: RemoteSessionOptions = {}): Promise<RemoteSession> {
