...
const MIGRATION_GUIDE_URL =
	"https://github.com/Zykairotis/ice/blob/void/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/Zykairotis/ice/blob/void/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.ice/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.ice/agent/ instead of
 * ~/.ice/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: upstream issue #320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by ice, so only warn if it has other files.
 */
