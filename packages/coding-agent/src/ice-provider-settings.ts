...
const LOCAL_REFETCH_STATUS_KEY = "ice-providers";
...
export default function iceProviderSettings(ice: ExtensionAPI): void {
	let sessionCtx: ExtensionContext | undefined;
	ice.on("session_start", (_event, ctx) => {
		sessionCtx = ctx;
	});
	ice.registerSettings("providers", {
		items: [
			{
				id: "providers",
				label: "Providers",
