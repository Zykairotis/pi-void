 ...
 *
 * Usage: ice --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@zykairotis/ice-tui";

export default function (ice: ExtensionAPI) {
	ice.registerCommand("overlay-test", {
