 ...
 * working indicator shown while ice is streaming a response.
 *
 * Usage:
 *   ice --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore ice's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@zykairotis/ice-coding-agent";
...
export default function (ice: ExtensionAPI) {
	...
	ice.registerCommand("working-indicator", {
