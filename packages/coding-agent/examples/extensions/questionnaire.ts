...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@zykairotis/ice-tui";
...
export default function questionnaire(ice: ExtensionAPI) {
	ice.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
