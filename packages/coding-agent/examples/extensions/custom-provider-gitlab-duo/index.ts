 ...
 * Delegates to ice-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   ice -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (ice: ExtensionAPI) {
	ice.registerProvider("gitlab-duo", {
