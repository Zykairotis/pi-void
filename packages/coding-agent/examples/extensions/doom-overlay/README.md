...
Play DOOM as an overlay in ice. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
ice --extension ./examples/extensions/doom-overlay
```
...
- [ice-doom](https://github.com/badlogic/ice-doom) for the original ice integration
