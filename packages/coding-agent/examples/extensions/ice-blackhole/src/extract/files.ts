...
// Ice never exposes a "createdFiles" field — Write operations are tracked as modified.
// FILE_CREATE_TOOLS kept as empty set for forward-compat if Ice adds a creation signal.
