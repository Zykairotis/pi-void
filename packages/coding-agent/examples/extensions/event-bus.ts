 ...
 *
 * Shows ice.events for communication between extensions. One extension
...
export default function (ice: ExtensionAPI) {
	...
	ice.events.on("my:notification", (data) => {
