 ...
 * Commands Extension
 *
 * Demonstrates the ice.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@zykairotis/ice-coding-agent";

export default function commandsExtension(ice: ExtensionAPI) {
	ice.registerCommand("commands", {
