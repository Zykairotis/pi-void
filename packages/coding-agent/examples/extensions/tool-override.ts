 ...
 * - Routing tool calls to remote systems (e.g., ice-ssh-remote)
...
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@zykairotis/ice-coding-agent";
