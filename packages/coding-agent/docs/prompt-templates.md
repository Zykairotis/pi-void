> ice can create prompt templates. Ask it to build one for your workflow.
...
Ice loads prompt templates from:

- Global: `~/.ice/agent/prompts/*.md`
- Project: `.ice/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `ice.prompts` entries in `package.json`
