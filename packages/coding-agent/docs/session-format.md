...
Source on GitHub ([ICE](https://github.com/Zykairotis/ice)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/Zykairotis/ice/blob/void/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/Zykairotis/ice/blob/void/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
- [`packages/ai/src/types.ts`](https://github.com/Zykairotis/ice/blob/void/packages/ai/src/types.ts) - Base message types (UserMessage, AssistantMessage, ToolResultMessage)
- [`packages/agent/src/types.ts`](https://github.com/Zykairotis/ice/blob/void/packages/agent/src/types.ts) - AgentMessage union type
