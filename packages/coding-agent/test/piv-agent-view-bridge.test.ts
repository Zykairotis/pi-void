...
import {
	PivAgentViewBridge,
	type PivAgentViewLiveSession,
	type PivAgentViewLiveSessionSource,
...
function createLiveSource(): {
	source: PivAgentViewLiveSessionSource;
	set: (sessions: readonly PivAgentViewLiveSession[]) => void;
} {
	let sessions: readonly PivAgentViewLiveSession[] = [];
...
describe("Pi Void agent view bridge", () => {
