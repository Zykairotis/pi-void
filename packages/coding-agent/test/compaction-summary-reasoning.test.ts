...
import type { AssistantMessage, Model } from "@zykairotis/ice-ai";
...
vi.mock("@zykairotis/ice-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@zykairotis/ice-ai/compat")>();
	return {
		...actual,
