...
import { Text, type TUI } from "@zykairotis/ice-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".ice", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .ice/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Ice documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
