...
- Fixed terminal width accounting for Indic conjunct grapheme clusters ([#6124](https://github.com/earendil-works/ice/issues/6124) by [@petrroll](https://github.com/petrroll)).
...
- Added interface-compatible main-screen and alternate-screen TUI renderers with application-owned scrolling ([#7304](https://github.com/earendil-works/ice/issues/7304)).
